...
console.log(arrr[0]); //number key may be or may be not wrappped in string
console.log(arrr['name']); //but others key should be wrapped inside string